...
public class Employees extends HttpServlet {
        ...
        try {
            ...
            try{
                for (Employee value: list) {
                    jsarr.put( new JSONObject().put("name",value.getName()).put("id", value.getId()).put("age", value.getAge()).put("wage", value.getWage()));
                }
    ...
    private void actionAdd(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        float _wage = Float.parseFloat(request.getParameter("wage"));
        Employee.addNew(_name, _age, _wage);
